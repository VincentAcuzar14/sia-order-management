...
// Define Routes
router.post("/api/suppliers", authMiddleware, supplierController.createSupplier);
router.get("/api/suppliers", authMiddleware, supplierController.getAllSuppliers);
router.get("/api/suppliers/:id", authMiddleware, supplierController.getSupplierById);
router.put("/api/suppliers/:id", authMiddleware, supplierController.updateSupplier);
router.delete("/api/suppliers/:id", authMiddleware, supplierController.deleteSupplier);

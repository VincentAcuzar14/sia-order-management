...
const options = {
  definition: {
    ...
    // Define API metadata
    info: {
      title: "Order Management API", // Name of your API
      version: "1.0.0", // API version
      description: "This WEB api is all about Order Management System", // Brief description
      contact: {
        name: "VincentAcuzar", // Contact person
        email: "vincentacuzar1414@gmail.com", // Contact email
      },
    },
